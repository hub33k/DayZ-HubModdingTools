...
class OpenModFolder : DayZTool {
	override void Run() {
		RunDayZPS1Script("P:\\HubModdingTools\\scripts\\OpenModFolder.ps1");
	}
}
...
class OpenServerFolder : DayZTool {
	override void Run() {
		RunDayZPS1Script("P:\\HubModdingTools\\scripts\\OpenServerFolder.ps1");
	}
}
...
class OpenHMTFolder : DayZTool {
	override void Run() {
		RunDayZPS1Script("P:\\HubModdingTools\\scripts\\OpenHMTFolder.ps1");
	}
}
...
class Start : DayZTool {
	override void Run() {
		RunDayZPS1Script("P:\\HubModdingTools\\scripts\\Start.ps1");
	}
}
...
class StopAll : DayZTool {
	override void Run() {
		RunDayZPS1Script("P:\\HubModdingTools\\scripts\\StopAll.ps1");
	}
}
...
class StopAllAndClean : DayZTool {
	override void Run() {
		RunDayZPS1Script("P:\\HubModdingTools\\scripts\\StopAllAndClean.ps1");
	}
}
...
class ClearLogs : DayZTool {
	override void Run() {
		RunDayZPS1Script("P:\\HubModdingTools\\scripts\\ClearLogs.ps1");
	}
}
...
class WipeServer : DayZTool {
	override void Run() {
		RunDayZPS1Script("P:\\HubModdingTools\\scripts\\WipeServer.ps1");
	}
}
